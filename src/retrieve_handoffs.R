...
in_url <- "https://github.com/AquaSat/AquaMatch_lakeSR/raw/refs/heads/main/e_calculate_handoffs/out/lakeSR_collated_handoffs_GEEv2025-02-12_QAv2025-06-04.csv"
...
if (!file.exists(file.path(handoff_download_path, "collated_handoffs.csv"))) {
  ...
  download.file(
    url = in_url,
    destfile = file.path(handoff_download_path, "collated_handoffs.csv")
  )
